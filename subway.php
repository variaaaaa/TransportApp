	...
	<div class="page">
		<div class="conteni">
            <div id="botoni1" style="display: block;">      
                <h1>Общая таблица</h1>
                <br> В Москве 250 станций. Какие-то из станций более популярны, чем другие. Но если посмотреть на пассажиропоток ВСЕХ станций в одном месте, ничего толком не понят (вся информация о станциях представлена после текста в качестве ознакомления).</br>
            ...
            <div id="button1" style="display: block;">      
                <h1>Общая таблица</h1>
                <br> На 2021 год метро состоит из 14 линий общей длиной 435,7 км в двухпутном исчислении без учёта монорельса и МЦК.</br>
                <br margin-bottom="10px"> В Московском метрополитене 250 станций, из которых 48 станций признаны объектами культурного наследия, а более 40 являются памятниками архитектуры.</br>
                <div class = "topFive">
                    <table bordercolor = "black" bgcolor = "white" width = "500" align="center" text-color="black">
            ...
            <h1>Таблица</h1>
                <br> Здесь вы можете увидеть пассажиропоток по линиям Московского метро за 3 квартал 2022 года.</br>
                <div class = "topFive">
                <div class = "topFive">
                    <table bordercolor = "black" bgcolor = "white" width = "500" align="center" text-color="black">
